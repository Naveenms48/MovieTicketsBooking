class MovieTicketBooking:
    ...
    def booktickets(self):
        while True:
            movie = input("1.Enter your movie name: Viduthalai/ Pushpa2/ Miss You/ Mufasa/ GOAT/ Lubber Pandhu / cancel ")
            if movie.lower() == "cancel":
                print("Booking process canceled")
                return movie

            if movie == "Viduthalai" or movie == "Pushpa2" or movie == "Miss You" or movie == "Mufasa" or movie=="GOAT" or movie=="Lubber Pandhu":
                print("Book Tickets")
                while True:
